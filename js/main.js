$(function () {
  "use strict";
  var e,
    i = document.getElementsByClassName("mil-accordion");
  ...
  $(".mil-menu-btn").on("click", function () {
    ...
    new Swiper(".mil-banner-slideshow", {
      ...
      autoplay: { delay: 5e3 },
      loop: !0,
      pagination: { el: ".mil-pagination", type: "bullets", clickable: !0 },
    }),
    ...
    new Swiper(".mil-works-slider2", {
        slidesPerView: 1,
        spaceBetween: 30,
        speed: 800,
        navigation: { prevEl: ".mil-works-prev2", nextEl: ".mil-works-next2" },
        breakpoints: { 768: { slidesPerView: 2 } },
      }),
